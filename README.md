...
1.  [Общее](2-GENERAL.md#2-общее "Общее")
    * [Общие правила стиля](2-GENERAL.md#21-общие-правила-стиля "Общие правила стиля")
      -  [Протокол](2%20GENERAL.md#211-протокол "Протокол")
    * [Общие правила форматирования](2-GENERAL.md#22-общие-правила-форматирования "Общие правила форматирования")
      -  [Отступы](2-GENERAL.md#221-отступы "Отступы")
      -  [Регистр](2-GENERAL.md#222-регистр "Регистр")
      -  [Заканчивающий пробел](2-GENERAL.md#223-заканчивающий-пробел "Заканчивающий пробел")
    * [Общие правила для метаданных](2-GENERAL.md#23-общие-правила-для-метаданных "Общие правила для метаданных")
      - [Кодировка](2-GENERAL.md#231-кодировка "Кодировка")
      - [Комментарии](2-GENERAL.md#232-комментарии "Комментарии")
      - [Метки действий (Action Items)](2-GENERAL.md#233-метки-действий-action-items "Метки действий (Action Items)")
